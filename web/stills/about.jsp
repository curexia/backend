    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="experts.html">Reach our Experts</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="medinfo.html">Know your medicines</a></li>
                        <li><a class="dropdown-item" href="symptomchecker.html">Symptoms</a></li>
                        <li><a class="dropdown-item" href="diseaseinfo.html">Diseases</a></li>
                        <!-- <li>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">CUREXIA<span></span></h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget no-box">
                        ...
                        <a class="btn" href="signup.html" target="_blank">Register Now</a>
                    </div>
                </div>
