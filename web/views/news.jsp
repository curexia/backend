  ...
  <div class="container midcase" style="padding: 10px">
    ...
    %>
      <div class="row featurette">
        <div class="col-lg-7">
          <h2 class="featurette-heading"><%=nw.getTitle()%></h2>
          <p class="lead"><%=nw.getDescription()%></p>
          <p><a href="<%=nw.getUrl()%>">Read more</a></p>
        </div>
        <div class="col-lg-5">
          <img class="rounded" style="padding-left: 10px;padding-right: 10px;" width="100%" height="250px" src="<%=nw.getUrltoimage()%>" aria-hidden="true"
